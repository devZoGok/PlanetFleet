...
namespace battleship{
	...
	Node* Unit::Weapon::initNode(sol::table weaponTable, bool horizontal){
	...
	Vector3 Unit::Weapon::calcOrientVec(int id){
		Vector3 orientVec;
	...
	void Unit::Weapon::alignNode(Vector3 targPos, Node *node, bool horizontal){
